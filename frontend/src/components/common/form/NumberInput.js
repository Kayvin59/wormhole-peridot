  ...
  return (
    <div className={styles.container}>
      ...
      {max !== undefined && showMaxButton && (
        <div
          className={conc(
            styles.max_button_container,
            cond(isDisabled, styles.max_button_container_disabled),
          )}
        >
          <button
            className={styles.max_button}
            onClick={(event) => handleMaxButton(event)}
            disabled={isDisabled}
          >
            MAX
          </button>
