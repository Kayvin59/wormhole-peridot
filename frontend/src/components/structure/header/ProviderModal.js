    ...
    <div className={styles.container}>
      <button className={styles.provider_button} onClick={handleMetaMaskButton}>
        <div>
          <img
            ...
            alt={"Connect with MetaMask to " + projectName}
          />
          <span>MetaMask</span>
        </div>
        ...
        <div
          className={conc(
            styles.provider_circle,
            cond(isMetaMaskActive, styles.provider_circle_active),
          )}
        ></div>
      </button>
      ...
      >
        <div>
          <img
            className={styles.provider_image}
            src={"/images/providers/walletconnect.svg"}
            alt={"Connect with WalletConnect to " + projectName}
          />
        ...
        <div
          className={conc(
            styles.provider_circle,
            cond(isWalletConnectActive, styles.provider_circle_active),
          )}
        ></div>
      </button>
    </div>
