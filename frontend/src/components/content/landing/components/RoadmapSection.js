  ...
  function getRows(bubbles) {
    return bubbles.props.children.map((bubble, index) => {
      ...
      return (
        <div
          key={index}
          className={conc(styles.row, cond(isReversed, styles.reverse))}
        >
          {bubble}
          ...
          <div className={styles.bar_container}>
            ...
            <div
              className={conc(
                styles.bar_circle_container,
                cond(isReversed, styles.reverse),
              )}
            >
      ...
      {getRows(
        <>
          <div className={styles.bubble}>
            ...
            <div
              className={conc(
                styles.bubble_content_container,
                styles.bubble_check,
              )}
            >
              <p>{arrow} test</p>
          ...
          <div className={styles.bubble}>
            <div className={styles.bubble_title}>Q2 2024</div>
          ...
          <div className={styles.bubble}>
            <div className={styles.bubble_title}>Q3 2024</div>
            <div className={styles.bubble_content_container}>
              <p>{arrow} test</p>
              <p>{arrow} test</p>
            </div>
          ...
          <div className={styles.bubble}>
            <div className={styles.bubble_title}>Q4 2024</div>
            <div className={styles.bubble_content_container}>
              <p>{arrow} test</p>
            </div>
          </div>
          ...
          <div className={styles.bubble}>
            <div className={styles.bubble_title}>Q1 2025</div>
            <div className={styles.bubble_content_container}>
              <p>{arrow} test</p>
            </div>
          </div>
